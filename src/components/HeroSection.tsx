...
export default function HeroSection() {
  return (
    ...
    >
      {/* ——— 4-column photo grid ——— */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-4 md:grid-rows-2 lg:grid-rows-1 min-h-screen w-full overflow-hidden hero-section-container">
